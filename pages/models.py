...
class Employee(models.Model):
    ...
    HireDate = models.DateField(default=datetime.today())
...
class Performance(models.Model):
    ...
    # OneToOneField instead of ForeignKey
...
class Badge(models.Model):
    ...
    BadgeImage = models.ImageField(
        upload_to='badge_images/', null=True, blank=True)
...
class TaskDeliverable(models.Model):
    ...
    DeliverableFile = models.FileField(
        upload_to='deliverables/', default='default_file.pdf')
