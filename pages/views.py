...
def employee_profile(request):
    ...
    current_month_performance = Performance.objects.filter(Employee=employee, created_at__month=current_month).first()
    ...
    if request.method == 'POST':
        ...
        deliverable_form = TaskDeliverableForm(request.POST, request.FILES, task_id=task_id)
...
def trainer(request):
    return render(request,'pages/trainer.html')
